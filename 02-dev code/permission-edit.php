...
$SQL="SELECT * FROM "._TB_PERMISSION." WHERE id='$id' LIMIT 1; ";
$re=mysql_query($SQL);
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row vertical-align">
                <div class="col-sm-8"><h3><i class="fa fa-angle-right"></i> แก้ไขสิทธิการใช้งาน</h3></div>
                    ...
                    <div class="content-panel col-lg-12">
                        ...
                        <form class="form-horizontal style-form" action="permission-script.php" id="frm" method="post">
                            ...
                            <div class="form-group col-sm-12 col-md-12">
                                ...
                                <div class="col-sm-12 col-md-9">
                                    <textarea class="form-control" rows="10" name="value" id="value"><?php echo $value; ?></textarea>
                                </div>
                            </div>
