...
$SQL="SELECT id, title,  update_dttm FROM "._TB_PERMISSION." WHERE publish='1' ";
$re=mysql_query($SQL);
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            ...
                                            <li><a href="permission-edit.php?id='.$id.'"><i class="fa fa-pencil-square-o"> แก้ไข</i></a></li>
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row vertical-align">
                <div class="col-sm-8"><h3><i class="fa fa-angle-right"></i> สิทธิการใช้งาน</h3></div>
                <!-- div class="col-sm-4 text-right"><a class="btn btn-primary" href="permission-add.php"><span class="glyphicon glyphicon-plus"></span> เพิ่มแผนกใหม่</a></div -->
            </div>
...
//        $("#permissionList_filter").add
    } );
	
function delete_item(id, title) {
	var chk=confirm("โปรดยืนยันการลบข้อมูล "+title+" !!");
	if (chk) {
		$.post("permission-script.php",{'act':'delete','id':id},function(data) {
