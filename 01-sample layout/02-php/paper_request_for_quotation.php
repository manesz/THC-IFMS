            ...
            <table class="table text-left" style="width: 1330px; margin: 0 0 20px 0;"><!-- customer content -->
                <tr>
                    <td style="width: 33%">
                        ...
                        <span class="seperator" style="width: 200px; float: left; text-align: left;">&nbsp;</span>
                    </td>
                    <td style="width: 33%">
                        <span style="width: 150px; border-bottom: none; float: left;">แผนก / Dept. :</span>
                        <span class="seperator" style="width: 250px; float: left; text-align: left;">&nbsp;</span>
                    </td>
                    <td style="width: 33%">
                        <span style="width: 150px; border-bottom: none; float: left;">ตำแหน่ง / Position :</span>
                        <span class="seperator" style="width: 275px; float: left; text-align: left;">&nbsp;</span>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="width: 33%">
                        <span style="width: 200px; border-bottom: none; float: left;">ชื่อบริษัท / Company's Name :</span>
                        <span class="seperator" style="width: 1110px; float: left; text-align: left;">&nbsp;</span>
                    </td>
                </tr>
                <tr>
                    <td colspan="3" style="width: 33%">
