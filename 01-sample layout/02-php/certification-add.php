            ...
            <div class="row" style="">
                <div class="col-md-12">
                    <div class="content-panel col-md-12">
                        <h3><i class="fa fa-angle-right"></i> <a href="certification-list.php">รายการ Certification</a> <i class="fa fa-angle-right"></i> สร้างรายการ Certification</h3>
                    </div>
                </div>
            </div><!-- /.row title -->
            ...
            <form class="form-horizontal style-form" method="post">
                ...
                <div class="row" style="">
                    <div class="col-md-12">
                        <div class="content-panel col-md-12">
                            <div class="row">
                                <label class="col-sm-12 col-md-4 control-label">เลขที่เอกสาร Certification </label>
                                <div class="col-lg-8">
